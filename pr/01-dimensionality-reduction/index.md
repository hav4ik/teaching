...
Если развернуть изображения в вектора значений пикселей, то возникает натуральный вопрос: какую форму имеет множество таких точек? Может, существует какая-нибудь проекция которая наилучшим образом различит наши классы цифр? Посчитаем собственные значения матрицы ковариации:
...
Можем заметить следующее: некоторые собственные значения 
