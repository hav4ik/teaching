...
Интерактивная демонстрация гистограммы направленных градиентов (HOG) на примере знаменитой специалистам компьютерного зрения фотографии ["Lenna"][lenna]. Для наглядности, каждому направлению градиентов соответствует отдельному цвету.
<hr>
